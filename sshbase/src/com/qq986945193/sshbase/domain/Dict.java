 ...
 */
public class Dict {
	private String dict_id;//主键ID
	private String dict_type_code;//数据字典类别代码01 06
	private String dict_type_name;//数据字典 类别名称01属于行业，06客户级别
	private String dict_item_name;//字典项目名称
	private String dict_item_code;//数据字典项目编号，可为空
	private Integer dict_sort;//排序字段
	private String dict_enable;//是否可用1，可用。0停用
